...
>
  {!draft ? (
    ...
    >
      {/* Left spacer keeps the middle perfectly centered on desktop */}
      {!isMobile && <div data-no-admin-tap />}

      {/* Centered hint, regardless of buttons */}
      <div
        className="hint"
        style={{
          color: '#a7b0b8',
      ...
      {/* Right: Explore buttons (desktop only) */}
      {!isMobile && (
        <div
          style={{ justifySelf: 'end', display: 'flex', gap: 10 }}
          data-no-admin-tap
        >
          {!exploring ? (
